...
#define GET_TCB_ADDR(p_entry) ((TCB *)(((void *)p_entry)-offsetof(TCB, global_queue_hook)))
//#define GET_TCB_ADDR(p_entry) ((TCB *)(((uintptr_t)p_entry)-136))
